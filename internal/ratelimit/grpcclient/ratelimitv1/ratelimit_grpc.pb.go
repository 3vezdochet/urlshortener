...
const (
	RateLimiter_Allow_FullMethodName = "/ratelimit.v1.RateLimiter/Allow"
)
...
var RateLimiter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ratelimit.v1.RateLimiter",
	...
	Metadata: "api/ratelimit/v1/ratelimit.proto",
}
